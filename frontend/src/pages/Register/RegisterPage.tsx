...
function Register({ isSignUp }: RegisterProps) {
    ...
    return (
        <div className={`absolute top-0 left-0 h-full w-1/2 flex flex-col justify-center p-12 bg-[#E0D4C0] transition-all duration-500 ease-in-out ${isSignUp ? "translate-x-full opacity-100 z-10" : "opacity-0 z-0"}`}>
            <form className="flex flex-col gap-4 h-full justify-center text-center" onSubmit={handleSubmit}>
                <h2 className="text-3xl font-bold mb-4 text-[#4E0000]">Create Account</h2>
